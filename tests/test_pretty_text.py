...
async def test_quote():
    ...
    res = (
        ...
        "я тут уже давно толкую, что ФФ не тот,\n"
        "что указан у аналов и на сайте\n"
        "мосбиржи  \n"
        "  \n"
...
async def test_image():
    ...
    res = (
        "| [Max__](https://clck.ru/EZuxS) @ [14.10.2018 09:24](https://clck.ru/EZuxT)\n"
        "|  \n"
...
async def test_quoting():
    ...
    res = await TestSource("http://mfd.ru").pretty_text(html)
    expected = (
        "| [Тул Равий](https://clck.ru/EaGNR) @ [09.11.2018 15:12](https://clck.ru/EgPPR)\n"
        "|  \n"
...
async def test_too_long():
    ...
    res = await TestSource("http://mfd.ru").pretty_text(html)
    exp = ("[Пумба](https://clck.ru/EjN9f)\n"
           "\n"
           "[19.11.2018 07:50](https://clck.ru/EoY4L)\n"
           "\n"
           "[ ](https://clck.ru/EoY4N)       \n"
           "\n"
           "\n"
           ...
           "[](https://clck.ru/EjN9f)\n"
           "\n"
           "[1987](https://clck.ru/EoY4M)\n"
           "\n"
           "[](http://mfd.ru/forum/poster/forecasts/?id=95837)[](https://clck.ru/EjN9f)\n"
           "\n"
           "|\n"
           "| \n"
           "| [emply](https://clck.ru/EgUu2) @ [19.11.2018 07:45](https://clck.ru/EjNK2)\n"
           "|  \n"
           "|  Шлак с кучей долгов\n"
           "| \n"
           "|\n"
           "| \n"
           "| | [Пумба](https://clck.ru/EjN9f) @ [19.11.2018 07:34](https://clck.ru/EjNFQ)\n"
           "| |  \n"
           ...
           "| | крупнейшая частная компания в\n"
           "| | сфере управления недвижимостью в\n"
           "| | Северо-Западном регионе и одна из\n"
           "| | крупнейших в России._  \n"
           "| |   \n"
           "| | I. **_Владелец_**  \n"
           "| | Грант Агасьян - бизнесмен, депутат\n"
           "| | Финляндский округ Санкт-\n"
           "| | Петербурга 5-го созыва, владелец\n"
           "| | Холдинга ПАО ГИТ.  \n"
           ...
           "| | Крыма в присоединении к\n"
           "| | Российской Федерации**. Имеет\n"
           "| | поощрения в работе с гражданами от\n"
           "| | ВПП «Единая Россия», Правительства\n"
           "| | Крыма. Член партии «Единая Россия».\n"
           "| | Работает над кандидатской\n"
           "| | диссертацией. **Председатель совета\n"
           "| | директоров ПАО «Городские\n"
           "| | инновационные технологии.** С\n"
           "| | 2014 г. – депутат Муниципального\n"
           "| | совета Финляндского округа.  \n"
           "| | [http://finokrug.spb.ru/publ/info/290](https://clck.ru/EjN9n)   \n"
           "| | 2. Является Организатором пикета за\n"
           "| | передачу Исаакиевского собора РПЦ  \n"
           "| | [https://echo.msk.ru/news/1917464-echo.html](https://clck.ru/EjNA2)   \n"
           "| | 3. Поддерживает главный\n"
           "| | Петербургский Крестный Ход  \n"
           "| | [http://paogit.ru/news/pao_git_krestniy_hod](https://clck.ru/EjN9m)   \n"
           "| | 4. Является владельцем ММА клуба\n"
           "| | \"СЕЧЬ\"  \n"
           "| | [https://vk.com/sech_mma](https://clck.ru/EjNA5)   \n"
           ...
           "| | [https://e-disclosure.azipi.ru/upload/iblock/4c1...](https://clck.ru/EjN9v) (приложение №2 стр. 17)   \n"
           "| | Холдинг управляет 4 916 227 кв.м.\n"
           "| | жилья  \n"
           "| | [http://funkyimg.com/view/2NgDT](https://clck.ru/EjN9r)   \n"
           "| | Таким образом ПАО ГИТ размещается\n"
           "| | на 10 месте среди УК РФ  \n"
           "| | [http://funkyimg.com/view/2NgDY](https://clck.ru/EjN9o)   \n"
           "| |   \n"
           ...
           "| | разведочные работы и геофизические\n"
           "| | работы; Услуги индивидуального\n"
           "| | проектирования, управления\n"
           "| | строительством, услуги по\n"
           "| | реконструкции и модернизации.\n"
           "| | Строительство жилых помещений,\n"
           "| | строительство коммерческой\n"
           "| | недвижимости; вывоз строительного\n"
           "| | и бытового мусора; Операции с\n"
           "| | недвижимым имуществом за\n"
           "| | вознаграждение или на договорной\n"
           "| | основе; Аренда и управление\n"
           "| | собственным или арендованным\n"
           "| | недвижимым имуществом;  \n"
           "| |   \n"
           "| | **На 18.11.2018 дочерние и\n"
           "| | зависимые общества являются\n"
...
async def test_text_width():
    font = ImageFont.truetype("LucidaGrande.ttc", 14, encoding="unic")
